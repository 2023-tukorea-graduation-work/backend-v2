...
public class ProgramListResponse {
    ...
    public ProgramListResponse(String memberName, String institution, Major major, Lesson lesson, Long programId, String subject, String detail, LocalDate programStartDate, LocalDate programFinishDate, Integer capacity, String programPlace, Long totalParticipants) {
