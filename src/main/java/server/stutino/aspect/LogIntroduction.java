...
public class LogIntroduction {
    @Pointcut("execution(* server.stutino..*Controller*.*(..))")
    public void allController() {}

    @Pointcut("execution(* server.stutino..*Service*.*(..))")
    public void allService() {}

    @Pointcut("execution(* server.stutino..*Repository*.*(..))")
